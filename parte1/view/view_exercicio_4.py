...
class ViewExercicio4:
    ...
    def salvarGraficos(resultadoDoTreinamento):
        ...
        graficoDaFuncaoObjetivoFoiSalvo = ViewExercicio1.salvarGrafico(resultadoDoTreinamento.getListaDaFuncaoObjetivo(), Constantes.TITULO_DO_GRAFICO_DA_FUNCAO_OBJETIVO_DO_NESTEROV, Constantes.TEXTO_DO_EIXO_DAS_ITERACOES, Constantes.TEXTO_DO_EIXO_DA_FUNCAO_OBJETIVO, Constantes.CAMINHO_DO_GRAFICO_DA_FUNCAO_OBJETIVO_DO_NESTEROV)

        graficoDaNormaDoGradienteFoiSalvo = ViewExercicio1.salvarGrafico(resultadoDoTreinamento.getListaDaNormaDoGradiente(), Constantes.TITULO_DO_GRAFICO_DA_NORMA_DO_GRADIENTE_DO_NESTEROV, Constantes.TEXTO_DO_EIXO_DAS_ITERACOES, Constantes.TEXTO_DO_EIXO_DA_NORMA_DO_GRADIENTE, Constantes.CAMINHO_DO_GRAFICO_DA_NORMA_DO_GRADIENTE_DO_NESTEROV)

        graficoDaAcuraciaFoiSalvo = ViewExercicio1.salvarGrafico(resultadoDoTreinamento.getListaDaAcuracia(), Constantes.TITULO_DO_GRAFICO_DA_ACURACIA_DO_NESTEROV, Constantes.TEXTO_DO_EIXO_DAS_ITERACOES, Constantes.TEXTO_DO_EIXO_DA_ACURACIA, Constantes.CAMINHO_DO_GRAFICO_DA_ACURACIA_DO_NESTEROV)
    ...
    def retornarTextoDoResumo(resultadoDoTreinamento, acuraciaDeTeste, configuracaoDoTreinamento):
        ...
        texto = "Exercício 4 - Nesterov Accelerated Gradient\n"
        texto = texto + "\n"
    ...
    def salvarResumo(resultadoDoTreinamento, acuraciaDeTeste, configuracaoDoTreinamento):
        texto = ViewExercicio4.retornarTextoDoResumo(resultadoDoTreinamento, acuraciaDeTeste, configuracaoDoTreinamento)
        ...
        try:
            ...
            arquivo = open(Constantes.CAMINHO_DO_ARQUIVO_DE_RESULTADOS_DO_EXERCICIO_4, Constantes.MODO_DE_ESCRITA, encoding=Constantes.CODIFICACAO_DOS_ARQUIVOS_DE_SAIDA)
            arquivo.write(texto)
            arquivo.close()
